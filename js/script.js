...
function createCars() {
  const automobili = [
    ...
    "Mercedes Benz Sprinter Lux",
    "Mercedes Benz Sprinter",
    "Mercedes Maybach S class",
    "Mercedes Benz S class",
    "Mercedes Benz gt",
  ];
  for (let cars of automobili) {
    const carsOption = document.createElement("option");
    const linkClass = document.getElementById("cars");
    carsOption.value = cars;
    carsOption.textContent = cars;
    //carsOption.classList.add("form-control");
    linkClass.appendChild(carsOption);
  }
}
createCars();
